  ...
  return (
    <section style={styles.ctaSection} aria-label="Book In-Home Care Now">
      <div style={styles.container}>
        <span className="section-kicker" style={{ justifyContent: "center", marginBottom: "1.25rem" }}>
          - 08 / Direct Clinical Concierge
        </span>
        <h2 style={styles.headline}>
          Hospital-Grade Care, <em>When Your Family Needs It Most.</em>
        </h2>
